...
public class StepAdapter$StepViewHolder_ViewBinding implements Unbinder {
  private StoneAdapter.StepViewHolder target;

  @UiThread
  public StepAdapter$StepViewHolder_ViewBinding(StoneAdapter.StepViewHolder target, View source) {
    this.target = target;
