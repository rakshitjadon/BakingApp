...
public class FetchDishes_ViewBinding implements Unbinder {
  private FetchDishes target;

  @UiThread
  public FetchDishes_ViewBinding(FetchDishes target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FetchDishes target = this.target;
